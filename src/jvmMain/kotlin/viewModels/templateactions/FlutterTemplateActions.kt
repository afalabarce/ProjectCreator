...
import io.github.afalabarce.projectcreator.entities.FlutterSettings
...
class FlutterTemplateActions: TemplateProjectAction() {
    override fun loadProject(templateProject: TemplateProject, onLoadTemplateProject: (TemplateProject) -> Unit) {
        ...
        onLoadTemplateProject(
            templateProject.copy(
                flutterSettings = (templateProject.flutterSettings ?: FlutterSettings()).copy(),
            )
        )
    }
